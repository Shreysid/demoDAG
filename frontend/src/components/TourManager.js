...
const TourManager = () => {
  ...
  const tourSteps = [
    ...
    },
    {
      title: "Submit",
      content:
        "Use the Submit button to get the details of number of nodes, edges and whether a DAG has been formed.",
    },
    {
      title: "Clear",
  ...
  return (
    <>
      {showTour && (
        <TourModal steps={tourSteps} onComplete={handleTourComplete} />
      )}
